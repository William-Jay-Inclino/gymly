<template>
    <nav v-if="global_store.user && global_store.user.role" class="flex w-full justify-around items-center py-2 bg-white rounded-xl shadow-md sticky top-0 left-0 max-w-full z-50 border-b border-base-200">
        <NuxtLink
